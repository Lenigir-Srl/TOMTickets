...
<div class="card" style="width: 35vw; margin-bottom:20px; margin-left: auto; margin-right:20px">
    <div class="container align-items-center justify-content-center d-flex"><div class="card-header"><h3>Cose divertenti da sapere</h3></div></div>
