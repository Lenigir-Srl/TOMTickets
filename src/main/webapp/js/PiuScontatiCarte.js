class eventCard{
    ...
    _getBody(){
        ...
        //Used to contain inside two halfs:
        //First half - Image
...
function mostraCards(datiJson) {
    ...
    var cardList = document.getElementById("piuScontatiCards");
...
function updateDiscountsTimer(){
    ...
    if(time == 0){
        ...
        document.getElementById("discountsTimer").innerHTML = time;
    }
}
...
document.addEventListener("DOMContentLoaded", function() {
    getDiscounts();
    window.setInterval(updateDiscountsTimer, 1000);
});
